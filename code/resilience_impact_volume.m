function [] = lmc_flow_event_ver6_repair_g_to_z15o_basket_190501(large_ind,pv_ind)
...
day_start = 1; % [2,89], [10,153]
day_end = 169; % (firm:13, day:31) (firm:1-30, day:32-61, error)
t = 100;
...
for firm = firm_start:firm_end
    ...
    for day=day_start:day_end
        [firm,day]
         if exist(sprintf('/home/minyoung/data_minyoung/Research/Price_Impact/data/qth_corr_data/result_AB_1905/%d/lmc_flow_event_ver6_AB_sign_1905_%d_%d_%d_%d_%d_%d.mat',com_num(firm),com_num(firm),day,id,t,large_ind,pv_ind),'file') && day~=26 ...
                && exist(sprintf('/home/minyoung/data_minyoung/Research/Price_Impact/data/qth_corr_data/result_AB_1905/%d/lmc_flow_event_ver6_AB_sign_ind_1905_%d_%d_%d_%d_%d_%d.mat',com_num(firm),com_num(firm),day,id,t,large_ind,pv_ind),'file') ...
                && exist(sprintf('/home/minyoung/data_minyoung/Research/Price_Impact/data/qth_corr_data/result_AB_1905/%d/lmc_flow_event_ver6_AB_sign_var_1905_%d_%d_%d_%d_%d_%d.mat',com_num(firm),com_num(firm),day,id,t,large_ind,pv_ind),'file')
                
            load(sprintf('/home/minyoung/data_minyoung/Research/Price_Impact/data/qth_corr_data/result_AB_1905/%d/lmc_flow_event_ver6_AB_sign_1905_%d_%d_%d_%d_%d_%d.mat',com_num(firm),com_num(firm),day,id,t,large_ind,pv_ind))
            load(sprintf('/home/minyoung/data_minyoung/Research/Price_Impact/data/qth_corr_data/result_AB_1905/%d/lmc_flow_event_ver6_AB_sign_ind_1905_%d_%d_%d_%d_%d_%d.mat',com_num(firm),com_num(firm),day,id,t,large_ind,pv_ind))
            load(sprintf('/home/minyoung/data_minyoung/Research/Price_Impact/data/qth_corr_data/result_AB_1905/%d/lmc_flow_event_ver6_AB_sign_var_1905_%d_%d_%d_%d_%d_%d.mat',com_num(firm),com_num(firm),day,id,t,large_ind,pv_ind))

            tick_bin_valid = round(100000*tick_bin_valid)/100000; % floating point

%             if length(find(price(2:end-1) - (price(1) + cumsum(price_return)) == 0)) ~= length(price_return)
%                 fid = fopen('basket_190501_error.txt','a');
%                 fprintf(fid,'%.0f %.0f\n',firm,day);
%                 fclose(fid);
%             end
            ...
            del_ind = find(sum_num < 1);
            save_ind = find(sum_num >= 1);
%             del_ind = find(sum_num < 100); % 1905, due to (large_ind, pv_ind)
%             save_ind = find(sum_num >= 100);
            
            if ~isempty(del_ind)
                fid = fopen('to_z15o_jump_1905.txt','a');
...
% save data
save(sprintf('/home/minyoung/data_minyoung/Research/Price_Impact/data/qth_corr_data/result_AB_1905/result_AB_Burst/z15o_basket_1905_%d_%d_%d_%d_%d_%d.mat',firm_start,firm_end,day_start,day_end,large_ind,pv_ind))
...
%     co = [0.0304;0.0333;0.5220;0.0437;0.6249;0.0554;0.7018;0.0677;0.7474;0];
%     
%     if flag_g == 1
...
%             lh = legend([h1 h2],{'Bid (Type A)','Ask (Type A)'});
%             legend boxoff
...
%     
% %     co = [0.0336;0.0380;0.6581;0.0493;0.8230;0.0627;0.9409;0.0772;1.0346;0];
%     co = [-0.031;-0.034;-0.524;-0.044;-0.627;-0.055;-0.690;-0.069;-0.724;0];
%     
%     if flag_g == 1
%         t1 = plot(1,co(i,1),'s','color',[0 0 0],'LineWidth',1,'MarkerSize',10);
%     elseif flag_g == 2
...
% h1 = plot(imm_ask(:,1),imm_bid(:,1),'*-','color',C2(2,:),'LineWidth',lw);
% hold on
...
% hold on
% plot(imm_ask(:,1),per_bid(:,1),'*-','color',C2(1,:),'LineWidth',lw);
% hold on
...
% hold on
% h3 = plot(imm_bid_minus(:,1),per_bid_minus(:,1),'*-','color',C2(1,:),'LineWidth',lw);
% hold on
...
% hold on
% h3 = plot(imm_ask(:,1),per_ask(:,1),'*-','color',C2(1,:),'LineWidth',lw);
% hold on
...
% 
% hold on
% h1 = plot(imm_bid_minus(:,1),imm_ask_minus(:,1),'*-','color',C2(2,:),'LineWidth',lw);
% hold on
...
% hold on
% plot(imm_bid_minus(:,1),per_ask_minus(:,1),'*-','color',C2(1,:),'LineWidth',lw)
% hold on
...
% subplot(2,2,3)
% hold on
% h1 = plot(imm_ask(:,1),imm_mid(:,1),'*-','color',C2(2,:),'LineWidth',lw);
% hold on
...
% hold on
% plot(imm_ask(:,1),per_mid(:,1),'*-','color',C2(1,:),'LineWidth',lw)
% hold on
...
% hold on
% 
% plot(imm_bid_minus(:,1),imm_mid_minus(:,1),'*-','color',C2(2,:),'LineWidth',lw)
% hold on
...
% hold on
% h3 = plot(imm_bid_minus(:,1),per_mid_minus(:,1),'*-','color',C2(1,:),'LineWidth',lw);
% hold on
...
% subplot(2,2,4)
% hold on
% h1 = plot(imm_ask(:,1),imm_spread(:,1),'*-','color',C2(2,:),'LineWidth',lw);
% hold on
...
% hold on
% plot(imm_ask(:,1),per_spread(:,1),'*-','color',C2(1,:),'LineWidth',lw)
% hold on
...
% hold on
% 
% plot(imm_bid_minus(:,1),imm_spread_minus(:,1),'*-','color',C2(2,:),'LineWidth',lw)
% hold on
...
% hold on
% h3 = plot(imm_bid_minus(:,1),per_spread_minus(:,1),'*-','color',C2(1,:),'LineWidth',lw);
% hold on
...
% subplot(2,2,1)
% hold on
% plot(imm_ask(:,1),imm_bid(:,1)+per_bid(:,1),'*-','LineWidth',lw,'color',[c1 c2 c3])
% hold on
% plot(imm_ask(2:end,2),imm_bid(2:end,2)+per_bid(2:end,2),'o--','LineWidth',lw,'color',[c1 c2 c3])
% hold on
% plot(imm_bid_minus(:,1),abs(imm_bid_minus(:,1)+per_bid_minus(:,1)),'*-','LineWidth',lw,'color',[c1 c2 c3])
% hold on
...
% subplot(2,2,2)
% hold on
% plot(imm_ask(:,1),imm_ask(:,1)+per_ask(:,1),'*-','LineWidth',lw,'color',[c1 c2 c3])
% hold on
% plot(imm_ask(2:end,2),imm_ask(2:end,2)+per_ask(2:end,2),'o--','LineWidth',lw,'color',[c1 c2 c3])
% hold on
% plot(imm_bid_minus(:,1),abs(imm_ask_minus(:,1)+per_ask_minus(:,1)),'*-','LineWidth',lw,'color',[c1 c2 c3])
% hold on
...
% subplot(2,2,3)
% hold on
% plot(imm_ask(:,1),imm_mid(:,1)+per_mid(:,1),'*-','LineWidth',lw,'color',[c1 c2 c3])
% hold on
% plot(imm_ask(2:end,2),imm_mid(2:end,2)+per_mid(2:end,2),'o--','LineWidth',lw,'color',[c1 c2 c3])
% hold on
% plot(imm_bid_minus(:,1),abs(imm_mid_minus(:,1)+per_mid_minus(:,1)),'*-','LineWidth',lw,'color',[c1 c2 c3])
% hold on
...
% subplot(2,2,4)
% hold on
% plot(imm_ask(:,1),imm_spread(:,1)+per_spread(:,1),'*-','LineWidth',lw,'color',[c1 c2 c3])
% hold on
% plot(imm_ask(2:end,2),imm_spread(2:end,2)+per_spread(2:end,2),'o--','LineWidth',lw,'color',[c1 c2 c3])
% hold on
% plot(imm_bid_minus(:,1),imm_spread_minus(:,1)+per_spread_minus(:,1),'*-','LineWidth',lw,'color',[c1 c2 c3])
% hold on
...
% if day_start == 1
%     hold on
%     f1 = plot(imm_ask(:,1),imm_spread(:,1)+per_spread(:,1),'*-','LineWidth',lw,'color',C4(ci,:));
%     hold on
%     f2 = plot(imm_ask(2:end,2),imm_spread(2:end,2)+per_spread(2:end,2),'o--','LineWidth',lw,'color',C4(ci,:));
%     hold on
%     plot(imm_bid_minus(:,1),imm_spread_minus(:,1)+per_spread_minus(:,1),'*-','LineWidth',lw,'color',C4(ci,:));
%     hold on
...
% elseif day_start == 31
%     hold on
%     f3 = plot(imm_ask(:,1),imm_spread(:,1)+per_spread(:,1),'*-','LineWidth',lw,'color',C4(ci,:));
%     hold on
...
%     hold on
%     f5 = plot(imm_ask(:,1),imm_spread(:,1)+per_spread(:,1),'*-','LineWidth',lw,'color',C4(ci,:));
%     hold on
